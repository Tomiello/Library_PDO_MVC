                            ...
                            <div class="col-xs-12">
                                <div class="form-group">
                                    ...
                                    <div class="radio radio-primary">
                                        <label>
                                            <input type="radio" name="optionsGenero" id="optionsRadios" value="Masculino" checked="">
                                            <i class="zmdi zmdi-male-alt"></i> &nbsp; Masculino
                                        </label>
                                    </div>
                                    <div class="radio radio-primary">
                                        <label>
                                            <input type="radio" name="optionsGenero" id="optionsRadioso" value="Femenino">
                ...
                <fieldset>
                    ...
                    <div class="container-fluid">
                        <div class="row">
                            ...
                            <?php if($_SESSION['privilegio_sbp']<2):?>
                                <div class="radio radio-primary">
                                    <label>
