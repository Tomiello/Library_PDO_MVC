...
<div class="container-fluid">
    <div class="panel panel-success">
        ...
        <div class="panel-body">
            <form action="<?php echo SERVERURL;?>ajax/cuentaAjax.php" method="POST" data-form="update" class="FormularioAjaxDatosCuenta" autocomplete="off" enctype="multipart/form-data">
                <?php
                    if($_SESSION['codigo_cuenta_sbp']!=$campos['CuentaCodigo']){
                        //no es el propetario de la cuenta
                        //verifico si el admin con privilegios
                        ...
                        <div class="row">
                            <div class="col-xs-12 col-sm-6">
                                <div class="form-group label-floating">
                                    ...
                                    value="<?php echo $campos['CuentaUsuario']; ?>" required="" maxlength="15">
                                </div>
                            </div>
                            <div class="col-xs-12 col-sm-6">
                                <div class="form-group label-floating">
                                    <label class="control-label">E-mail</label>
                                    <input class="form-control" type="email" name="email-up" 
                                    value="<?php echo $campos['CuentaEmail']; ?>"
                                    maxlength="50">
                                </div>
                            </div>
                            <div class="col-xs-12 col-sm-6">
                                <div class="form-group">
                                    ...
                                    <div class="radio radio-primary">
                                        <label>
                                            <input type="radio" name="optionsGenero" id="optionsRadio" 
                                            <?php if($campos['CuentaGenero']=='Masculino'){echo 'checked=""';}?> value="Masculino">
                                            <i class="zmdi zmdi-male-alt"></i> &nbsp; Masculino
                                        </label>
                                    </div>
                                    <div class="radio radio-primary">
                                        <label>
                                            <input type="radio" name="optionsGenero" id="optionsRadios" 
                                            <?php if($campos['CuentaGenero']=='Femenino'){echo 'checked=""';}?> value="Femenino">
								...
								<div class="form-group">
									...
									<div class="radio radio-primary">
										<label>
                                            ...
                                            <?php if ($campos['CuentaEstado']=="Activo") {
                                                echo 'checked=""';
                                            } ?> value="Activo" >
									...
									<div class="radio radio-primary">
										<label>
                                            <input type="radio" name="optionsEstado-up"
                                            <?php if ($campos['CuentaEstado']=="Deshabilitado") {
                                                echo 'checked=""';
                                            } ?>  value="Deshabilitado"  >
                    ...
                    <div class="container-fluid">
                        <div class="row">
                            ...
                            <div class="col-xs-12 col-sm-6">
                                <div class="radio radio-primary">
                                    <label>
                                        <input type="radio" name="optionsPrivilegio" id="optionsRadios1" value="<?php echo $lc->encryption(1); ?>" <?php if($campos['CuentaPrivilegio']==1){ echo 'checked=""'; } ?> >
                                        <i class="zmdi zmdi-star"></i> &nbsp; Nivel 1
                                    </label>
                                </div>
                                <div class="radio radio-primary">
                                    <label>
                                        <input type="radio" name="optionsPrivilegio" id="optionsRadios2" value="<?php echo $lc->encryption(2); ?>" <?php if($campos['CuentaPrivilegio']==2){ echo 'checked=""'; } ?> >
                                        <i class="zmdi zmdi-star"></i> &nbsp; Nivel 2
                                    </label>
                                </div>
                                <div class="radio radio-primary">
                                    <label>
                                        <input type="radio" name="optionsPrivilegio" id="optionsRadios3" value="<?php echo $lc->encryption(3); ?>" checked="" <?php if($campos['CuentaPrivilegio']==3){ echo 'checked=""'; } ?> >
                ...
                <div class="RespuestaAjaxDatosCuenta"></div>
            </form>
        </div>
    </div>
</div>
