<?php
    //si no es un administrador no puede entrar a esta pagina
...
<div class="container-fluid">
    <div class="panel panel-primary">
        ...
        <?php
            //views es la variable del archivo htaccess
            $pagina = explode("/", $_GET['views']);
            //$pagina es un array con los datos buscador en la url
            echo $insAdmin->paginador_administrador_controlador($pagina[1],1,$_SESSION['privilegio_sbp'],$_SESSION['codigo_cuenta_sbp'],$_SESSION['busqueda_admin']);
        ?>
        </div>
    </div>
</div>
